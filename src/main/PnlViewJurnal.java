...
public class PnlViewJurnal extends javax.swing.JPanel {
    ...
    public void generateTable(){
        try {
            ...
            myStmt = myConn.prepareStatement("SELECT a.jurnal_no,a.chart_no,a.chart_name,a.debit,a.kredit,b.description,b.date FROM"
                    + " jurnal_detail a inner join jurnal_master b on a.jurnal_no=b.jurnal_no;");
            // Execute SQL query
            ...
            if (myRs.isBeforeFirst()) {
                while (myRs.next()) {
                    Object data[] = {myRs.getString("jurnal_no"),myRs.getString("date"), myRs.getString("chart_no"),
                        myRs.getString("chart_name"),myRs.getString("description"),myRs.getDouble("debit"), myRs.getDouble("kredit")};
    ...
    private void btnViewJurnalDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewJurnalDeleteActionPerformed
        //SELECT a.jurnal_no,a.chart_no,a.chart_name,a.debit,a.kredit,b.description FROM jurnal_detail a inner join jurnal_master b on a.jurnal_no=b.jurnal_no;
